  ...
  return (
    <div className="min-h-screen bg-gray-100 px-4 md:px-10 py-6 ">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between mb-8">
        ...
        <button className="flex items-center gap-2 text-lg font-medium hover:text-orange-500 transition">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-[350px]   bg-white rounded-2xl shadow-md p-6 h-fit">
          ...
          <div className="flex justify-between mt-6">
            ...
            <h1 className="text-3xl text-orange-500 font-bold">₹667</h1>
          </div>

          {/* Free Delivery Message */}

          <div className="bg-green-100 text-green-700 rounded-xl p-3 mt-6 text-center font-medium">
